...
ui <- fluidPage(
  titlePanel("SEIR with Vital Dynamics (Counts) - v2"),
  sidebarLayout(
    sidebarPanel(
      ...
      numericInput("mu", "Birth = death rate μ (per day):", 
                   value = 0.000039, min = 0, max = 0.1, step = 0.000001),
      helpText("For homework: μ = 1/70 years⁻¹ ≈ 0.000039 day⁻¹ or μ = 1/50 years⁻¹ ≈ 0.000055 day⁻¹"),
      
      tags$hr(),
      numericInput("S0", "Initial S0:", value = 999990, min = 0, step = 1),
      numericInput("E0", "Initial E0:", value = 0,      min = 0, step = 1),
      numericInput("I0", "Initial I0:", value = 10,     min = 0, step = 1),
      numericInput("R0_init", "Initial R0:", value = 0, min = 0, step = 1),
      
      tags$hr(),
      numericInput("days", "Simulation days:", value = 73000, min = 1, step = 1),
      helpText("For homework: simulate for 73,000 days (≈ 200 years)"),
